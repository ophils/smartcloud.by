...
m4_changecom(`[[[[')
m4_dnl ---- m4_changeword(`[_a-zA-Z][_a-zA-Z0-9<>]*') return to std
m4_define(`_concat', `ifelse(1, $#, `$1', `$1` '_concat(shift($@))')')
m4_define(`_amp', `&amp;')
m4_define(`_l_d', m4_esyscmd(`echo -n $(hostname -d)'))
m4_define(`_local_domain', m4_ifelse(_l_d, gomel.by, cm.gomel.by, `_l_d'))
m4_dnl m4_define(`_local_domain', `cm.gomel.by')
